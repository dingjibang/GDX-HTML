...
public class TypedGdxQuery<T extends Actor> extends GdxQuery{
	...
	private CustomRunnable<Boolean> touchUpButtonRun;
	...
	private InputListener clickListener() {
		return _clickListener != null ? _clickListener : (_clickListener = new InputListener(){
			public void touchUp (InputEvent event, float x, float y, int pointer, int b) {
				...
				if(touchUpButtonRun != null) touchUpButtonRun.run(b == Buttons.LEFT);
			}
	...
	public TypedGdxQuery<T> touchUpButton(CustomRunnable<Boolean> run){
		this.touchUpButtonRun = run;
		return _tryRegListener();
	}
